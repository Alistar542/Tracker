        ...
        <ExcelFile
          ...
          element={
            <Tooltip title="Download as Excel" arrow>
              <CloudDownloadIcon className={classes.icontheme} />
            </Tooltip>
          }
        >
          <ExcelSheet data={dataSet1} name="Students">
            ...
            <ExcelColumn
              ...
              value="proposalInfo.visaApplnStatus"
            />
            <ExcelColumn
              label="Visa Process Date"
              value="proposalInfo.visaApplnPrcDate"
            />
            <ExcelColumn label="Visa Status" value="proposalInfo.visaStatus" />
            <ExcelColumn
              label="Visa Appr/Rej Date"
              value="proposalInfo.visaApRjDate"
            />
            <ExcelColumn label="Travel Date" value="proposalInfo.travelDate" />
            <ExcelColumn label="Enrolled>>>>>>" value="************" />
            <ExcelColumn
              label="Course Starting Date"
              value="enrolledInfo.courseStartingDate"
            />
            <ExcelColumn
              label="Currency"
              value={(enrolledInfo) =>
                enrolledInfo.currency ? enrolledInfo.currency : ""
              }
            />
            <ExcelColumn
              label="Total Tution Fees"
              value={(enrolledInfo) =>
                enrolledInfo.totalTutionFees ? enrolledInfo.totalTutionFees : ""
              }
            />
            <ExcelColumn
              label="Annual Tution Fees"
              value={(enrolledInfo) =>
                enrolledInfo.annualTutionFees
                  ? enrolledInfo.annualTutionFees
                  : ""
              }
            />
            <ExcelColumn
              ...
              value={(enrolledInfo) =>
                enrolledInfo.totalCommission ? enrolledInfo.totalCommission : ""
              }
            />
            <ExcelColumn
              label="First Commission"
              value={(enrolledInfo) =>
                enrolledInfo.firstCommission ? enrolledInfo.firstCommission : ""
              }
            />
            <ExcelColumn
              label="Invoice Date"
              value={(enrolledInfo) =>
                enrolledInfo.invoiceDate
                  ? enrolledInfo.invoiceDate.slice(0, 19).replace("T", " ")
                  : ""
              }
            />
            <ExcelColumn
              ...
              value={(enrolledInfo) =>
                enrolledInfo.nextInvoiceDate
                  ? enrolledInfo.nextInvoiceDate.slice(0, 19).replace("T", " ")
                  : ""
              }
            />
            <ExcelColumn
              ...
              value={(enrolledInfo) =>
                enrolledInfo.balanceCommission
                  ? enrolledInfo.balanceCommission
                  : ""
              }
            />
